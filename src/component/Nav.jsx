                ...
                {navigation.map((item) => (
                  <a
                    ...
                    className={clsx(
                      ...
                      "whitespace-nowrap rounded-3xl px-2 py-2 text-base font-medium text-white",
                    )}
                  >
                    {item.name}
                  </a>
            ...
            <DisclosureButton
              ...
              className={clsx(
                item.current
                  ? "bg-lagoon"
                  : "hover:bg-white/5 hover:text-white",
                "block whitespace-nowrap rounded-3xl px-3 py-2 text-base font-medium text-white",
              )}
            >
              {item.name}
            </DisclosureButton>
